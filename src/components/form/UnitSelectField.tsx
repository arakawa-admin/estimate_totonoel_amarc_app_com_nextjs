...
import { getMasterUnits } from "@/app/actions/masterUnit";
import type { MasterUnitType } from "@/schemas/masterUnitSchema";
...
export default function UnitSelectField({
    ...
    useEffect(() => {
        (async () => {
            const data: MasterUnitType[] = await getMasterUnits();
